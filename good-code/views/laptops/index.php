...
<form action="">
  <div id="search-bar">
    <div class="input-group mb-3">
      <input type="text" class="form-control" placeholder="Search for product" name="search" value="<?php echo $search ?>" aria-label="Recipient's username" aria-describedby="button-addon2">
